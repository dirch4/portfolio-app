...
class $AssetsImagesGen {
  ...
  AssetGenImage get github =>
      const AssetGenImage('assets/images/github.png');
  /// File path: assets/images/dimas.jpg
  AssetGenImage get dimas => const AssetGenImage('assets/images/dimas.jpg');

  /// File path: assets/images/dimas2.jpg
  AssetGenImage get dimas2Jpg =>
      const AssetGenImage('assets/images/dimas2.jpg');

  /// File path: assets/images/dimas2.png
  AssetGenImage get dimas2Png =>
      const AssetGenImage('assets/images/dimas2.png');

  /// File path: assets/images/logo_unpak.png
  AssetGenImage get logoUnpak =>
      const AssetGenImage('assets/images/logo_unpak.png');
  ...
  AssetGenImage get lingkar9 =>
      const AssetGenImage('assets/imageslingkar9.PNG');
